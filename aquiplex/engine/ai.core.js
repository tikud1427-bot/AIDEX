...
async function generateAI(messages, opts = {}) {
  ...
  if (process.env.GROQ_API_KEY) {
    try {
      ...
      console.error(`[ai.core] Groq failed: ${err.message}`);
    }
  }
  ...
  if (process.env.OPENROUTER_API_KEY) {
    try {
      ...
      console.error(`[ai.core] OpenRouter failed: ${err.message}`);
    }
  }
  ...
  if (process.env.GEMINI_API_KEY) {
    try {
      ...
      console.error(`[ai.core] Gemini failed: ${err.message}`);
    }
  }
...
module.exports = { generateAI, generateImage, generateSearch };