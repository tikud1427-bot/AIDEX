...
report_state() {
  ...
  for marker in \
      ...
      "PR-7  ../tests/platform/repoHygiene.test.js" \
      "E2/1  eval/core/runner.mjs" \
      "E2/2  eval/datasets/extraction-core.v1.json" \
      ...
      "E3/10  E3_SCALING_FINDING.md" \
      "E5/1   src/core/db/migrations/0006_claims.sql" \
      "E5/2   src/core/claims/predicateRegistry.js" \
      ...
      "E4/1   src/core/jobs/jobRegistry.js" \
      "FLAKE1  src/core/tests/helpers/perfShape.mjs" \
      "FIND1   src/files/tests/contradictionFinding.test.js" \
      "EVAL1   eval/baselines/contradiction-core.v1.json" \
      ...
      "FIX6    AQUA_INDEXED_NOT_SCAN.md" \
      "FIND2   src/files/tests/forensicFinding.test.js" \
      "EVAL3   eval/baselines/forensic-edited.v1.json"; do
